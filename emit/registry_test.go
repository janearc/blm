...
func TestNilPublisher_IsNoOp(t *testing.T) {
	var p *Publisher
	if err := p.Publish(context.Background(), "t", "s", "schema", "k", &observabilityv1.ServiceHealthHeartbeat{}); err != nil {
...
func TestPublish_SchemaErrorPropagates(t *testing.T) {
	...
	err := p.Publish(context.Background(), "topic", "subj", "schema", "key", &observabilityv1.ServiceHealthHeartbeat{})
	if err == nil {
...
func TestSchemaID_RegistersOnceAndCaches(t *testing.T) {
	...
	id, err := p.schemaID(context.Background(), "observability.v1.ServiceHealthHeartbeat", "schema-text")
	if err != nil {
	...
	if _, err := p.schemaID(context.Background(), "observability.v1.ServiceHealthHeartbeat", "schema-text"); err != nil {
